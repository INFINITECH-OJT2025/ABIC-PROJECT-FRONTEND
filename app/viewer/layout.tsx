...
import { viewerNav } from "@/lib/navigation";
...
export default function ViewerLayout({
  ...
  return (
    <div className="h-screen overflow-hidden flex bg-gradient-to-br from-[#F9F0F2] via-[#F5E8EC] to-[#F0E0E6]">
      <AppSidebar roleLabel="Viewer" basePath="/viewer" user={user} onLogout={handleLogout} navigation={viewerNav} />
